...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED_HEART_Pin|LED_NET_Pin|LED_ALM_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, OLED_SCL_Pin|OLED_SDA_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : LED_HEART_Pin LED_NET_Pin LED_ALM_Pin */
  GPIO_InitStruct.Pin = LED_HEART_Pin|LED_NET_Pin|LED_ALM_Pin;
