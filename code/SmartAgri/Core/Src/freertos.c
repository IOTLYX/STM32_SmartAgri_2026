...
extern void uiTaskStart(void *argument);
extern void netTaskStart(void *argument);
extern void ctrlTaskStart(void *argument);
...
void MX_FREERTOS_Init(void) {
  ...
  sensorTaskHandle = osThreadNew(sensorTaskStart, NULL, &sensorTask_attributes);

  /* creation of uiTask */
  uiTaskHandle = osThreadNew(uiTaskStart, NULL, &uiTask_attributes);

  /* creation of netTask */
  netTaskHandle = osThreadNew(netTaskStart, NULL, &netTask_attributes);

  /* creation of ctrlTask */
  ctrlTaskHandle = osThreadNew(ctrlTaskStart, NULL, &ctrlTask_attributes);
...
__weak void sensorTaskStart(void *argument)
{
